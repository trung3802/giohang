...
<head>
    ...
    <link rel="icon" href="../admin/content/images/logo.png" type="image/gif" sizes="16x16">
    <!-- Bootstrap -->
    ...
    <!-- Slick slider -->
    <link rel="stylesheet" href="../admin/content/css/slick-theme.css" type="text/css">
    <link rel="stylesheet" href="../admin/content/css/slick.css" type="text/css">
...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarsExampleDefault">
                    <ul class="navbar-nav m-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="product.html">Liên hệ</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <div class="widgets-wrap float-md-right ml-4">
                            ...
                            <div class="widget-header icontext">
                                ...
                                <div class="text">
                                    ...
                                    <div>
                                        <a class="text-info" href="#">Đăng nhập</a> |
                                        <a class="text-info" href="#"> Đăng ký</a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-lg-2 col-xl-2 mx-auto">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href=""><i class="fas fa-phone-volume"></i> 0982084197</a></li>
                        <li><a href=""><i class="fas fa-envelope"></i>hieunmph17303@fpt.edu.vn</a></li>
                    </ul>
                </div>
                ...
                <div class="col-md-3 col-lg-3 col-xl-3">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><i class="fa fa-envelope mr-2"></i> hieunmph17303@fpt.edu.vn</li>
                        <li><i class="fa fa-phone mr-2"></i> + 0987654321</li>
                        <li><i class="fa fa-print mr-2"></i> + 0987654321</li>
                    </ul>
                </div>
    ...
    <!-- Js -->
    <script src="../admin/content/js/jquery-3.6.0.min.js"></script>
    <script src="../admin/content/js/bootstrap.min.js"></script>
    <script src="../admin/content/js/slick.min.js"></script>
