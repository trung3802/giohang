        ...
        <div class="my-auto">
            ...
            <ul class="fa-ul mb-4 ml-0">
                <li id="mail-address">
                    ...
                    <i class="fas fa-envelope-open mr-2 contact-icons"></i>haidnph39387@fpt.edu.vn</a>
                </li>
                <li>
                    <i class="fas fa-mobile-alt mr-2 contact-icons"></i>0987880968
                </li>
                <li>
                    <i class="fas fa-map-marker-alt mr-2 contact-icons"></i>Trịnh Văn Bô, Nam Từ Liêm
                </li>
            </ul>
